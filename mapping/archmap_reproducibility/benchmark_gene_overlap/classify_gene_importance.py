...
def classify(cell_type_key_list, query_name):
    ...
    adata = sc.read(f"{query_name}_mappped.h5ad")
    ...
    query_latent = sc.AnnData(query_adata.obsm["latent_rep"])
    reference_latent = sc.AnnData(reference_adata.obsm["latent_rep"])
